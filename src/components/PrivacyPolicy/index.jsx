      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className='p-2 z-50 rounded fixed bg-white h-[80%] w-1/2 overflow-y-scroll top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]'>
          ...
          <p className='w-full h-auto'>
            A sua privacidade é importante para nós. É política da Global Transportes respeitar a sua privacidade em relação a qualquer
            informação sua que possamos coletar no site Global Transportes, e
          ...
          <p className='w-full h-auto'>
            ...
            informação que a Global Transportes oferece no site e com caráter
          ...
          <div className='pl-5'>
            ...
            <li>
              ...
              (softwares) da Global Transportes, de seus fornecedores ou terceiros,
